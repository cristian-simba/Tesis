...
import { LuLayoutDashboard, LuUsers2, LuBell } from 'react-icons/lu';
            ...
            <Flex gap="5" align="center">
              ...
              <div ref={ref} onClick={() => setOpen(!open)}>  
                <div onClick={() => setOpen(!open)} role="button" tabIndex={0} onKeyDown={(event) => { if (event.key === 'Enter') setOpen(!open); }}>
                  ...
                  <div className={`transition-opacity duration-150 ${open ? 'opacity-0' : 'opacity-100'} absolute top-16 right-4`}>
