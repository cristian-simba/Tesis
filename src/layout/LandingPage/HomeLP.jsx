...
function HomeLP() {
  return (
    <section>
        <Grid columns='2' align='center' gap='5' className='px-24 min-h-screen'>
        ...
        <Flex justify='center' align='center' className='mt-[-70px] pt-5 hover:cursor-pointer'>
            <Text size='2' className='font-bold pr-1'>Asi es como funciona</Text>
